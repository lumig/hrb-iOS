...
#define itemHeight  (SCREEN_WIDTH==320.0? 60: (SCREEN_WIDTH==375.0?70:80))
...
- (instancetype)init
{
    self = [super init];
    if (self) {
        self.headerReferenceSize = CGSizeMake(SCREEN_WIDTH, 64.0f);//头部视图的框架大小
        self.itemSize = CGSizeMake(SCREEN_WIDTH/7, itemHeight);//每个cell的大小
